...
import classes from 'assets/styles/Header/Header.module.css';
      ...
      <div className={classes.Content}>
        <div className={classes.TitleBox}>
            ...
            <>
              <div
                className={classNames(classes.Title, {
                  [classes.selected]: basePath === RESERVE_PATH,
                })}
                onClick={() => {
              ...
              {!location.state && (
                <div
                  className={classNames(classes.Title, {
                    [classes.selected]: basePath === LOOKUP_PATH,
                  })}
                  onClick={() => {
          ...
          {basePath === RESERVE_INFO_PATH && (
            <div
              className={classNames(classes.Title, {
                [classes.selected]: basePath === RESERVE_INFO_PATH,
              })}
            >
              상세 내역
            </div>
          ...
          {basePath === QR_PATH && (
            <div
              className={classNames(classes.Title, { [classes.selected]: basePath === QR_PATH })}
            >
              QR 체크인
            </div>
          )}
